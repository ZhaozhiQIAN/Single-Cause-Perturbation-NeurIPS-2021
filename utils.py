...
def create_DR_CRN(single_cause_index, d_config, param, linear_model=False):
    model = DR_CRN(single_cause_index, d_config.n_confounder, d_config.n_cause, d_config.n_outcome,
                   param.n_confounder_rep, param.n_outcome_rep, param.mmd_sigma,
                   param.lam_factual, param.lam_propensity, param.lam_mmd, linear=linear_model)
    return model

def create_NN_SCP(single_cause_index, d_config, param):
    model = NN_SCP(single_cause_index, d_config.n_confounder, d_config.n_cause, d_config.n_outcome,
                   param.n_confounder_rep, param.n_outcome_rep, param.mmd_sigma,
                   param.lam_factual, param.lam_propensity, param.lam_mmd)
    return model
