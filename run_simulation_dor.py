...
def run(d_config, eval_only=False, n_ensemble=0, eval_delta=False, seed=None, no_confounder=False, linear_model=False,
        outcome_interaction3=False, dense_connection=False):
    ...
    for param in param_list:
        ...
        model = DirectOutcomeRegression(n_confounder, n_cause, n_outcome, n_hidden=param.n_outcome_rep + param.n_confounder_rep, linear=linear_model)
    ...
    model = DirectOutcomeRegression(n_confounder, n_cause, n_outcome,
                                    n_hidden=best_param.n_outcome_rep + best_param.n_confounder_rep, linear=linear_model)
    # load best iteration
...
if __name__ == '__main__':
    ...
    run(config1, eval_only=False, n_ensemble=subset, seed=args.seed, no_confounder=args.no_confounder,
        linear_model=args.linear_model, outcome_interaction3=args.outcome_interaction3, dense_connection=args.dense_connection)
